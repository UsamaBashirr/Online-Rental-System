...
<div class="container rounded shadow-lg px-4 py-5 bg-white" style="margin-top:10%; max-width: 420px">
    <h3 class="text-center mb-5">Login as a Owner</h3>
    ...
    <form action="{{ URL::to('loginowner') }}" method="post">
        @csrf
        ...
        <p class="text-center mt-3"> New Member? <a href="{{ URL::to('signupasowner') }}"> Start here  </a></p>
