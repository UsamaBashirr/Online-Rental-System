...
<div class="container rounded shadow-lg px-4 py-5 bg-white" style="margin-top:3%; max-width: 420px">
    <h3 class="text-center mb-4">SignUp as a Owner</h3>
    ...
    <form action="{{ URL::to('signupowner') }}" method="post">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="cnic" placeholder="Enter the CNIC"
                id="cnic" required />

            <span class="text-danger">@error('cnic')
                    {{ $message }}
                @enderror</span>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="shopname" placeholder="Enter the Shop Name" id="shopname" required />

            <span class="text-danger">@error('shopname')
                    {{ $message }}
                @enderror</span>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="shopaddress" placeholder="Enter the Shop Address" id="shopaddress" required />

            <span class="text-danger">@error('shopaddress')
                    {{ $message }}
                @enderror</span>
        </div>
        ...
        <p class="text-center mt-3"> Already have an account? <a href="{{ URL::to('loginasowner') }}"> Sign-In  </a></p>
